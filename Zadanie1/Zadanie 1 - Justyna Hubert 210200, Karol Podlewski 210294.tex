...
Wygląd strony przypomina omawianą wcześniej witrynę wydawnictwa Rebel. Szata graficzna jest przejrzysta oraz czytelna. Czcionka mogłaby być trochę większa, a układ trochę bardziej przemyślany. Obecne multimedia doskonale wpasowują się w charakter strony.  \\

Jeśli chodzi o część funkcjonalną, to dostajemy pokaźną ilość odnośników do stron innych sprzedawców, dzięki którym zamówimy angielskie książki nawet do Polski, jest to jednak delikatne utrudnienie - bezpośrednio na witrynie nie jesteśmy w stanie nic kupić - przyznaliśmy tylko po jednym punkcie w kategoriach zapłaty i dostawy. Panel kontaktowy jest rozbudowany i bogaty, a wersja mobilna świetnie się prezentuje. \\
